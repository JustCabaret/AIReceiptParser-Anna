...
ENTRY_FILE="receipt_parser_plugin.py"
OUT_DIR="dist-anna"
...
cat <<JSON
"$PLATFORM": {
  "url": "https://github.com/<your-github-username>/AIReceiptParser-Anna/releases/download/receipt-parser-v$VERSION/$TOOL_ID-$PLATFORM.tar.gz",
  "sha256": "$SHA256",
  "size": $SIZE,
